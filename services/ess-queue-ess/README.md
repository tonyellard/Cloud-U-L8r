...
# Set endpoint
export AWS_ENDPOINT_URL=http://localhost:9320

# Create queue
aws sqs create-queue --queue-name test-queue

# Send message
aws sqs send-message --queue-url http://localhost:9320/test-queue --message-body "Test message"

# Receive messages
aws sqs receive-message --queue-url http://localhost:9320/test-queue

# Delete queue
aws sqs delete-queue --queue-url http://localhost:9320/test-queue
```
